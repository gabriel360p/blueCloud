...
<body class="app">   	
  ...
  <path fill-rule="evenodd" d="M11 2a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12h.5a.5.5 0 0 1 0 1H.5a.5.5 0 0 1 0-1H1v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h1V7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7h1V2zm1 12h2V2h-2v12zm-3 0V7H7v7h2zm-5 0v-3H2v3h2z"/>
						...
						{{-- Chama um modal, o modal vai ter o uplaod do arquivo e a seleção de uma pasta --}}
						...
						{{-- Chama um modal que vai ter como criar uma pasta --}}
						<div class="app-utility-item">
			            ...
			            <div class="app-utility-item app-user-dropdown dropdown">
				            <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false"><img src="{{asset('dashboard/assets/images/user.png')}}" alt="user profile"></a>
        ...
        <div id="app-sidepanel" class="app-sidepanel"> 
	        ...
	        <div class="sidepanel-inner d-flex flex-column">
		        <a href="/dash" id="sidepanel-close" class="sidepanel-close d-xl-none">&times;</a>
		        <div class="app-branding">
		            <a class="app-logo" href="/dash"><img class="logo-icon me-2" src="{{asset('dashboard/assets/images/app-logo.svg')}}" alt="logo"><span class="logo-text">PORTAL</span></a>
...
<div class="app-wrapper">
    ...
    <script src="{{asset('dashboard/assets/js/index-charts.js')}}"></script> 
